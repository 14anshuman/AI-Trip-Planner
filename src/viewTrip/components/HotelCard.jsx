  ...
  return (
    <>
      ...
      >
        <div
          key={index}
          className="rounded-lg   overflow-hidden shadow-md hover:shadow-xl bg-gradient-to-r from-slate-100 to-gray-200 transition-shadow duration-300 cursor-pointer  "
        >
          <img
